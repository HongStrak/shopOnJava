		...
		<div class="col-main">
			<div class="main-wrap">
				...
				<div class="user-address">
				    ...
				    <c:forEach items="${addr }"  var="addres">
							<c:if test="${addres.isDefaultAddr!=null&&addres.isDefaultAddr eq '1'}">
							<li class="user-addresslist defaultAddr">
							
									<span class="new-option-r"><i class="am-icon-check-circle"></i>默认地址</span>
							
						
									 <span class="new-txt">${addres.receiver }</span> <span
										class="new-txt-rd2">${addres.tel }</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">地址：</span> <span class="province">${addres.address }</span>
									</p>
								</div>
								
								<div class="new-addr-btn">
									
                                   <a href="/addr/toupdate.do?id=${addres.id }"><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="/addr/delete.do?id=${addres.id }"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
							</c:if>
					...
					<c:forEach items="${addr }"  var="addre">
				
							<li class="user-addresslist defaultAddr">
							
							
									<span class="new-option-r"><i class="am-icon-check-circle"></i>
									<a href="/addr/setDefault.do?id=${addre.id }">设为默认</a></span>
						
									 <span class="new-txt">${addre.receiver }</span> <span
										class="new-txt-rd2">${addre.tel }</span>
								</p>
								<div class="new-mu_l2a new-p-re">
									<p class="new-mu_l2cw">
										<span class="title">地址：</span> <span class="province">${addre.address }</span>
									</p>
								</div>
								
								<div class="new-addr-btn">
									
                                   <a href="/addr/toupdate.do?id=${addre.id }"><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="/addr/delete.do?id=${addre.id }"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
							...
							<div class="add-dress" id="app">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="/addr/addradd.do" method="post">
